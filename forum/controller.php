...
if ($_POST['page'] == 'StartPage')
{
	...
	switch ($command) {
		...
		default:
			echo "Unknown command from Profile page.";
			exit();
			break;
	}
...
else if($_POST['page'] == 'picture'){
	if($_FILES['picture']['name']){
		$tmpFilePath = $_FILES['picture']['tmp_name'];
		if($tmpFilePath != ""){
			$shortname = $_FILES['picture']['name'];
			$filePath = "avatar/avatar-".$_SESSION['username'].".png";
